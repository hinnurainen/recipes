            ...
            <section id="gallery"><div className="container">
                <div className="gallery-grid">
                    <div className="grid-item-1 grid-div">
                        <img src="https://source.unsplash.com/nDYLkcu_gYo/1600x900"
                            alt="snack pic from unsplash" />
                    </div>
                    ...
                    <div className="grid-item-3 grid-div">
                        <img src="https://source.unsplash.com/mP8HvwFA_dw/1600x900"
                            alt="snack pic from unsplash" />
                    </div>
                    <div className="grid-item-4 grid-div">
                        <img src="https://source.unsplash.com/ElGnfom4tIw/1600x900"
                            alt="snack pic from unsplash" />
                    </div>
                    <div className="grid-item-5 grid-div">
                        <img src="https://source.unsplash.com/mmsQUgMLqUo/1600x900"
                            alt="snack pic from unsplash" />
                    </div>
                    <div className="grid-item-6 grid-div">
                        <img src="https://source.unsplash.com/wGEtPYgFWP8/1600x900"
                            alt="snack pic from unsplash" />
                    </div>
                    ...
                    <div className="grid-item-9 grid-div">
                        <img src="https://source.unsplash.com/HK4n3W95F2c/1600x900"
                            alt="snack pic from unsplash" />
                    </div>
                </div>
            </div>
